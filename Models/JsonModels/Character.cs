...
namespace HZBot
{
    public class Character
    {
        ...
        public CharacterStat Stamina => new CharacterStat(.2f) { StatType = StatType.Stamina, BaseValue = stat_base_stamina, BoughtValue = stat_bought_stamina, TotalValue = stat_total_stamina, TrainingValue = training_progress_value_stamina, TrainingMaxValue = training_progress_end_stamina };
        public CharacterStat Strength => new CharacterStat(.5f) { StatType = StatType.Strength, BaseValue = stat_base_strength, BoughtValue = stat_bought_strength, TotalValue = stat_total_strength, TrainingValue = training_progress_value_strength, TrainingMaxValue = training_progress_end_strength };
        public CharacterStat CriticalRating => new CharacterStat(1) { StatType = StatType.CriticalRating, BaseValue = stat_base_critical_rating, BoughtValue = stat_bought_critical_rating, TotalValue = stat_total_critical_rating, TrainingValue = training_progress_value_critical_rating, TrainingMaxValue = training_progress_end_critical_rating };
        public CharacterStat DodgeRating => new CharacterStat(1) { StatType = StatType.DodgeRating, BaseValue = stat_base_dodge_rating, BoughtValue = stat_bought_dodge_rating, TotalValue = stat_total_dodge_rating, TrainingValue = training_progress_value_dodge_rating, TrainingMaxValue = training_progress_end_dodge_rating };
